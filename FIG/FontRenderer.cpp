...
namespace FIG
{
    ...
    bool FontRenderer::CheckGLError()
    {
    ...
    BoundingBox FontRenderer::Bounds(const char * const text)
    {
        ...
        bool kerning = settings.useKerning && FT_HAS_KERNING(font->face);
        ...
        return BoundingBox{ -offset, offset, 0, lineCount * (float)(font->face->size->metrics.height / 64) };
    }
